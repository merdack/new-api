...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.GET("/zarinpal/return", controller.ZarinpalReturn)
			userRoute.GET("/zibal/return", controller.ZibalReturn)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/zarinpal/pay", middleware.CriticalRateLimit(), controller.RequestZarinpalPay)
				selfRoute.POST("/zarinpal/amount", controller.RequestZarinpalAmount)
				selfRoute.POST("/zibal/pay", middleware.CriticalRateLimit(), controller.RequestZibalPay)
				selfRoute.POST("/iranian/pay", middleware.CriticalRateLimit(), controller.RequestIranianPay)
				selfRoute.POST("/iranian/amount", controller.RequestIranianAmount)
